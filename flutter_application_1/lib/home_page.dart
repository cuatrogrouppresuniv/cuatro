    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => AddComplaintPage(user: user)),
          );
        },
        child: Icon(Icons.add),
        backgroundColor: Colors.blue, // Atur warna latar belakang tombol sesuai kebutuhan
      ),
    );
  }
}
...
class _ComplaintListState extends State<ComplaintList> {
  ...
  Future<void> fetchComplaints() async {
    ...
    await databaseRef.orderByChild('userId').equalTo(widget.user.id).onValue.listen((data) { 
            ...
            child: Card(
              ...
              child: ListTile(
                ...
                onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => ComplaintDetailPage(user: widget.user,complaint: complaints[index])),
                    );
                },
              ),
            ),
