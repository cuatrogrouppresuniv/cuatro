...
import com.example.cuatros.AdminFragment
import com.example.cuatros.MenuFragment
import com.example.cuatros.R
import com.example.cuatros.model.Complaint

class ComplaintsAdapter(private val mList: List<Complaint>, menuFragment: AdminFragment) : RecyclerView.Adapter<ComplaintsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.textView.setOnClickListener {
            ...
            fragment.findNavController().navigate(R.id.action_AdminFragment_to_DetailAdminFragment,a)
